...
const App = () => {
  ...
  useEffect(() => {
    const fetchBooks = async () => {
      try {
        const response = await axios.get("https://ecom-books-backend.onrender.com/books");
    ...
    const fetchUserInfo = async () => {
      ...
      try {
        const response = await axios.get("https://ecom-books-backend.onrender.com/user/token", {
