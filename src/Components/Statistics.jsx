    ...
    const fetchData = async () => {
      try {
        ...
        const [customersResponse, booksResponse, buyingResponse] =
          await Promise.all([
            axios.get("https://ecom-books-backend.onrender.com/customers", {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            }),
            axios.get("https://ecom-books-backend.onrender.com/books", {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            }),
            axios.get("https://ecom-books-backend.onrender.com/buyingmodules", {
              headers: {
                Authorization: `Bearer ${token}`,
              },
            }),
