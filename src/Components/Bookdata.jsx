...
const BookDashboard = () => {
  ...
  const fetchBooks = () => {
    setTimeout(() => {
      axios
        .get("https://ecom-books-backend.onrender.com/books", {
          headers: {
  ...
  const handleDelete = (bookId) => {
    if (window.confirm("Are you sure you want to delete this book?")) {
      axios
        .delete(`https://ecom-books-backend.onrender.com/books/${bookId}`, {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("token")}`,
          },
        })
  ...
  const handleSaveEdit = (updatedBook) => {
    axios
      .put(`https://ecom-books-backend.onrender.com/books/${updatedBook._id}`, updatedBook, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token")}`,
        },
      })
