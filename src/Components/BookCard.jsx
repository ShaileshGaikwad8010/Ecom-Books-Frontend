...
const BookCard = ({ book, token, isExpanded, onExpand, onRemove }) => {
  ...
  const handleFavoriteClick = async () => {
    ...
    try {
      if (!isFavorite) {
        await axios.put(
          "https://ecom-books-backend.onrender.com/wishlist",
        ...
        await axios.delete("https://ecom-books-backend.onrender.com/wishlist", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
          data: {
  ...
  const handleBuyNowClick = async () => {
    ...
    try {
      const response = await axios.get(
        `https://ecom-books-backend.onrender.com/user/address/${userEmail}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleBuyConfirm = async () => {
    try {
      ...
      const response = await axios.post(
        "https://ecom-books-backend.onrender.com/purchase",
        {
