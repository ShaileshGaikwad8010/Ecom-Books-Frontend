...
const CustomerDashboard = () => {
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        ...
        const response = await axios.get("https://ecom-books-backend.onrender.com/customers", {
          headers: {
  ...
  const handleSaveEdit = async () => {
    try {
      const token = sessionStorage.getItem("token");
      await axios.put(
        `https://ecom-books-backend.onrender.com/customers/${editingCustomerId}`,
        editedCustomer,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDelete = async (id) => {
    try {
      const token = sessionStorage.getItem("token");
      await axios.delete(`https://ecom-books-backend.onrender.com/customers/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
